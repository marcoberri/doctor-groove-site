...
<title>
	:::: Doctor Groove Live Band - people ::::
</title>
</HEAD>
			...
			<table border="0" cellpadding="5" cellspacing="5">
				<tr>
					...
					<td valign="top" width="625">
						<p align="center"><img src="images/people.gif"></p>
													<p align="center" style="font-size:30px;">${obj.fields.title.value}</p>
												<p align="center" class="center_block">${obj.fields.body.value.replaceAll("/doctorgroove/","/")}</p>
											</td>
				</tr>
			</table>
		</td>
